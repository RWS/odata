...
/**
 * Parser for Action request body in XML format. It returns action or actionImport instance based on input parameters.
 */
public class ODataAtomActionParser extends AbstractActionParser {

    public ODataAtomActionParser(ODataRequestContext newRequestContext) {
        super(newRequestContext);
    }

    @Override
    public Map<String, Object> parseRequestBody(String body) throws ODataNotImplementedException {
