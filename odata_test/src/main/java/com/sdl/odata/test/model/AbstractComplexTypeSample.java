...
/**
 * The Abstract Complex Type Sample.
 */
@EdmComplex(namespace = "ODataDemo")
public abstract class AbstractComplexTypeSample {
    ...
    public AbstractComplexTypeSample setInheritedProperty(String newInheritedProperty) {
