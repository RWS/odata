...
/**
 * Function import sample model.
 */
@EdmFunctionImport(function = "UnboundODataDemoFunction", includeInServiceDocument = true,
        name = "ODataDemoFunctionImport", namespace = "ODataDemo")
